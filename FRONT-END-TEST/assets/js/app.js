$(function	(){
	//array filled with objects with product info 
	 var products = [],

	//the filters object will hold an array of values for each filter
	...
	//event handlers to help with frontend navigation

	var checkboxes = $('.entire-products input[type=checkbox]');
	...
	$.getJSON( "products.json", function( data ) {
		...
		generateentireProductsHTML(products);
	...
	function generateentireProductsHTML(data){

		var list = $('.entire-products .products-list');
	...
	function renderProductsPage(data){
		...
		var page = $('.entire-products'),
			entireProducts = $('.entire-products .products-list > li');

		// Hide all the products in the products list.
		entireProducts.addClass('hidden');

		// Iterate over all of the products.
		// If their ID is somewhere in the data object remove the hidden class to reveal them.
		entireProducts.each(function () {
